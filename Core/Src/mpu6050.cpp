...
void mpu6050::MPU6050_Read_Accel(I2C_HandleTypeDef *I2Cx,MPU6050_t *DataStruct)
{
	uint8_t Rec_Data[6];
...
void mpu6050::MPU6050_Read_Gyro(I2C_HandleTypeDef *I2Cx,MPU6050_t *DataStruct)
{
	uint8_t Rec_Data[6];
...
void mpu6050::MPU6050_Read_Temp(I2C_HandleTypeDef * I2Cx,MPU6050_t *DataStruct)
{
	uint8_t Rec_Data[2];
	int16_t temp;
